...
static struct clk_lookup msm_clocks_samarium[] = {
	...
	CLK_LOOKUP("iface_clk", mdss_ahb_clk.c, "fd928000.qti,iommu"),
	CLK_LOOKUP("core_clk", mdss_axi_clk.c, "fd928000.qti,iommu"),
	CLK_LOOKUP("iface_clk", camss_vfe_vfe_ahb_clk.c, "fda44000.qti,iommu"),
	CLK_LOOKUP("core_clk", camss_vfe_vfe_axi_clk.c, "fda44000.qti,iommu"),
	CLK_LOOKUP("alt_iface_clk", camss_ahb_clk.c,  "fda44000.qti,iommu"),
	...
	CLK_LOOKUP("core_clk", camss_jpeg_jpeg_axi_clk.c,
					 "fda64000.qti,iommu"),
	CLK_LOOKUP("alt_iface_clk", camss_ahb_clk.c,  "fda64000.qti,iommu"),
