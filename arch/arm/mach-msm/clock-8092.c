...
static struct clk_lookup mpq_clocks_8092_rumi[] = {
	CLK_DUMMY("xo",	cxo_pil_lpass_clk.c,	"fe200000.qti,lpass", OFF),
	...
	CLK_DUMMY("bus_clk",	gcc_lpass_q6_axi_clk.c,
					"fe200000.qti,lpass", OFF),
	CLK_DUMMY("core_clk",	dummy_clk,	"fe200000.qti,lpass", OFF),
	CLK_DUMMY("iface_clk",	dummy_clk,	"fe200000.qti,lpass", OFF),
	CLK_DUMMY("reg_clk",	dummy_clk,	"fe200000.qti,lpass", OFF),
	...
	CLK_DUMMY("pixel_clk", vcap_afe_pixel_clk.c,
		"fdfa8000.qti,vcap_comp", OFF),
	CLK_DUMMY("iface_clk", vcap_ahb_clk.c, "fdf80000.qti,vcap", OFF),
	CLK_DUMMY("iface_clk", vcap_ahb_clk.c, "fdfac000.qti,vcap_ttl", OFF),
	CLK_DUMMY("iface_clk", vcap_ahb_clk.c, "fdf98000.qti,hdmi_rx", OFF),
	CLK_DUMMY("iface_clk", vcap_ahb_clk.c, "fdfa8000.qti,vcap_comp", OFF),
	CLK_DUMMY("iface_clk", vcap_ahb_clk.c, "fdfa0000.qti,vcap_sdvd", OFF),
	CLK_DUMMY("iface_clk", vcap_ahb_clk.c, "qti,vcap_aafe.0", OFF),
	CLK_DUMMY("bus_clk", vcap_axi_clk.c, "fdf80000.qti,vcap", OFF),
	CLK_DUMMY("bus_clk", vcap_axi_clk.c, "fdfa0000.qti,vcap_sdvd", OFF),
	CLK_DUMMY("audio_clk", vcap_audio_clk.c, "fdf98000.qti,hdmi_rx", OFF),
	CLK_DUMMY("cfg_clk", vcap_cfg_clk.c, "fdf98000.qti,hdmi_rx", OFF),
	CLK_DUMMY("bus_clk", vcap_hdmi_bus_clk.c, "fdf98000.qti,hdmi_rx", OFF),
	CLK_DUMMY("pixel_clk", vcap_hdmi_rx_clk.c,
		"fdf98000.qti,hdmi_rx", OFF),
	CLK_DUMMY("md_clk",	vcap_md_clk.c,	"fdf98000.qti,hdmi_rx", OFF),
	CLK_DUMMY("bus_clk",	vcap_ttl_clk.c,	"fdfac000.qti,vcap_ttl", OFF),
	CLK_DUMMY("debug_clk",	vcap_ttl_debug_clk.c,
		"fdfac000.qti,vcap_ttl", OFF),
	CLK_DUMMY("ext_clk",	vcap_vafe_ext_clk.c,
		"fdfa0000.qti,vcap_sdvd", OFF),
	CLK_DUMMY("ext_clk",	vcap_vafe_ext_clk.c,	"qti,vcap_aafe.0", OFF),
	CLK_DUMMY("core_clk",	vcap_vp_clk.c,	"fdf80000.qti,vcap", OFF),
	CLK_DUMMY("core_clk",	vcap_vp_clk.c,	"fdfac000.qti,vcap_ttl", OFF),
	CLK_DUMMY("core_clk",	vcap_vp_clk.c,	"fdf98000.qti,hdmi_rx", OFF),
	CLK_DUMMY("core_clk",	vcap_vp_clk.c,	"fdfa8000.qti,vcap_comp", OFF),
	CLK_DUMMY("core_clk",	vcap_vp_clk.c,	"fdfa0000.qti,vcap_sdvd", OFF),
	CLK_DUMMY("core_clk",	vcap_vp_clk.c,	"qti,vcap_aafe.0", OFF),
	CLK_DUMMY("",   venus0_vcodec0_clk.c,   "", OFF),
	CLK_DUMMY("iface_clk",	venus0_ahb_clk.c, "fdce0000.qti,venus", OFF),
	CLK_DUMMY("bus_clk",	venus0_axi_clk.c, "fdce0000.qti,venus", OFF),
	CLK_DUMMY("",	venus0_core0_vcodec_clk.c, "", OFF),
	CLK_DUMMY("",	venus0_core1_vcodec_clk.c, "", OFF),
	CLK_DUMMY("mem_clk", venus0_ocmemnoc_clk.c, "fdce0000.qti,venus", OFF),
	CLK_DUMMY("core_clk", venus0_vcodec0_clk.c, "fdce0000.qti,venus", OFF),
	...
	CLK_DUMMY("iface_clk", vpu_ahb_clk.c, "fde0b000.qti,pil-vpu", OFF),
	CLK_DUMMY("bus_clk", vpu_axi_clk.c, "fde0b000.qti,pil-vpu", OFF),
	CLK_DUMMY("vdp_clk", vpu_vdp_clk.c, "fde0b000.qti,pil-vpu", OFF),
	CLK_DUMMY("vdp_bus_clk", vpu_bus_clk.c, "fde0b000.qti,pil-vpu", OFF),
	CLK_DUMMY("cxo_clk", vpu_cxo_clk.c, "fde0b000.qti,pil-vpu", OFF),
	CLK_DUMMY("core_clk", vpu_maple_clk.c, "fde0b000.qti,pil-vpu", OFF),
	CLK_DUMMY("sleep_clk", vpu_sleep_clk.c, "fde0b000.qti,pil-vpu", OFF),
	...
	CLK_DUMMY("iface_clk", NULL, "fd92a000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fd92a000.qti,iommu", OFF),
	...
	CLK_DUMMY("iface_clk", NULL, "fdfb6000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fdfb6000.qti,iommu", OFF),
	CLK_DUMMY("alt_core_clk", NULL, "fdfb6000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk", NULL, "fc734000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fc734000.qti,iommu", OFF),
	CLK_DUMMY("alt_core_clk", NULL, "fc734000.qti,iommu", OFF),
	/* BCSS broadcast */
...
static struct clk_lookup mpq_clocks_8092[] = {
	...
	CLK_LOOKUP("iface_clk",	vcap_ahb_clk.c,	"fdf98000.qti,hdmi_rx"),
	CLK_LOOKUP("iface_clk", vcap_ahb_clk.c, "fdfa8000.qti,vcap_comp"),
	CLK_LOOKUP("iface_clk", vcap_ahb_clk.c, "fdfa0000.qti,vcap_sdvd"),
	CLK_LOOKUP("iface_clk", vcap_ahb_clk.c, "qti,vcap_aafe.0"),
	CLK_LOOKUP("bus_clk",	vcap_axi_clk.c,	"fdf80000.qti,vcap"),
	CLK_LOOKUP("bus_clk", vcap_axi_clk.c, "fdfa0000.qti,vcap_sdvd"),
	CLK_LOOKUP("cfg_clk",	vcap_cfg_clk.c, "fdf98000.qti,hdmi_rx"),
	CLK_LOOKUP("md_clk", vcap_md_clk.c,	"fdf98000.qti,hdmi_rx"),
	CLK_LOOKUP("core_clk",	vcap_vp_clk.c,	"fdf80000.qti,vcap"),
	CLK_LOOKUP("core_clk",	vcap_vp_clk.c,	"fdfac000.qti,vcap_ttl"),
	CLK_LOOKUP("core_clk",	vcap_vp_clk.c,	"fdf98000.qti,hdmi_rx"),
	CLK_LOOKUP("core_clk",	vcap_vp_clk.c,	"fdfa8000.qti,vcap_comp"),
	CLK_LOOKUP("core_clk",	vcap_vp_clk.c,	"fdfa0000.qti,vcap_sdvd"),
	CLK_LOOKUP("core_clk",	vcap_vp_clk.c,	"qti,vcap_aafe.0"),
	...
	CLK_LOOKUP("alt_iface_clk", camss_micro_ahb_clk.c,
						"fda64000.qti,iommu"),
	CLK_LOOKUP("iface_clk", mdss_ahb_clk.c , "fd92a000.qti,iommu"),
	CLK_LOOKUP("core_clk", mdss_axi_clk.c , "fd92a000.qti,iommu"),
	...
	CLK_LOOKUP("iface_clk", bcc_vbif_ahb_clk.c, "fc734000.qti,iommu"),
	CLK_LOOKUP("core_clk", bcc_vbif_axi_clk.c, "fc734000.qti,iommu"),
